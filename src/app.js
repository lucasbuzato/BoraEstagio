    ...
    <footer class="site-footer">
      <div class="footer-inner">
        ...
        <div class="footer-links">
          ...
          <div><strong>Projeto</strong><button type="button" data-reset-demo>Reiniciar demonstração</button><span>MVP acadêmico</span></div>
        </div>
      </div>
